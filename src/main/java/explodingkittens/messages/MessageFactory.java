...
public class MessageFactory {
    ...
    /**
     * @param message    the content of the message you want to create
     * @param choices    the choices the message should contain
     * @param needAnswer 1 if the message needs an answer else 0
